...
function CalculatorInner({
    ...
    return (
        <Container
            ml={largeScreen ? 600 : midScreen ? 400 : 280}
            mt={60} mb={60}
        >
            <Paper radius="md" p={largeScreen ? 100 : 30} shadow="lg" mt={30}>
                <Form onSubmit={handleSubmit} className="mb-3">
                    <Form.Group className="mt-3 mb-5">
                        ...
                        <Form.Control type="number" onChange={handleChange} name="principal" value={principal} style={{ width: "700px" }} />
                        {/* <input onChange={handleChange} name="principal" value={principal} /> */}
                    </Form.Group>

                    <Form.Group className="mb-5">
                        <Form.Label>Rate of Interest(in%): </Form.Label>
                        <Form.Control type="number" onChange={handleChange} name="rate" value={rate} />
                        {/* <input onChange={handleChange} name="rate" value={rate} /> */}
                    </Form.Group>

                    <Form.Group className="mb-5">
                        <Form.Label>Num of Monthly Installments: </Form.Label>
                        <Form.Control type="number" size="10" onChange={handleChange} name="months" value={months} />
                        {/* <input onChange={handleChange} name="months" value={months} /> */}
                    </Form.Group>

                    <Button type="submit" style={{width:"200px"}}>Calculate EMI for Loan</Button>
                    {emi && (
                        <div className="mt-2">
